...
Page({
        ...
        * */
        onLoad: function (options) {
            let dataIsFormCart = options.from == 'cart'
            this.data.dataIsFormCart = dataIsFormCart;
            this.data.account = options.account;
            const products = this._getCartDataIsSelect()
        ...
        */
        ...
        //获取缓存中购物车已经选中的数据
        _getCartDataIsSelect(){
          const cartData = wx.getStorageSync('cart')
          return cartData.filter((item) => item.selectStatus == true)
        }
